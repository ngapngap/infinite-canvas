      ...
      <section className="relative mx-auto min-h-[calc(100vh-4rem)] max-w-7xl overflow-hidden px-6">
        ...
        <div className="relative flex min-h-[620px] flex-col items-center justify-center pt-10 text-center">
          ...
          <p className="mt-8 max-w-3xl text-balance text-lg leading-8 text-stone-500 dark:text-stone-400">
            {t("hero.description")} {t("hero.ecosystemPrefix")} <a href="https://ramclouds.me" target="_blank" rel="noreferrer" className="font-medium text-stone-700 underline underline-offset-4 transition hover:text-stone-950 dark:text-stone-300 dark:hover:text-stone-100">Ramclouds</a> {t("hero.ecosystemMiddle")} <a href="https://ramrouter.me" target="_blank" rel="noreferrer" className="font-medium text-stone-700 underline underline-offset-4 transition hover:text-stone-950 dark:text-stone-300 dark:hover:text-stone-100">RamRouter</a>{t("hero.ecosystemSuffix")}
          </p>
